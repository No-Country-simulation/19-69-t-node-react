    ...
    <div className="relative flex items-center justify-center h-screen bg-cover bg-center bg-black z-0">
      ...
      <div className="relative flex flex-col items-center justify-center z-10 text-center text-white">
        ...
        <div className="animate-appear900 opacity-0 mt-10 text-lg">
          <Link to="/menu" className="px-3 sm:px-6 py-2 me-5 text-white bg-[#1a1a1a] hover:bg-red-800 border-b border-red-800 rounded-md transition-all">
            Menu
          </Link>
          <Link to="/menu" className="px-2 sm:px-4 py-2 text-white bg-[#1a1a1a] hover:bg-red-800 border-b border-red-800 rounded-md transition-all">
            Reservar
          </Link>
        </div>
      </div>
